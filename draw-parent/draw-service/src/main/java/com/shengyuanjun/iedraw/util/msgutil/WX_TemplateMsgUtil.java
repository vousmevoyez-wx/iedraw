...
public class WX_TemplateMsgUtil {
     ...
     * @return 模板ID
     */
    public static String getWXTemplateMsgId(String templateSerialNumber,String accesstoken){
     ...
     * @return
     */
    public static String deleteWXTemplateMsgById(String templateId,String accesstoken){
